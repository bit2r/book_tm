...
```{r echo=F, ap, fig.cap="AP 기사", out.width="100%"}
...
```{r echo=F, ap2, fig.cap="AP 기사 주제", out.width="100%"}
...
```{r echo=F, dpi=30, topic, fig.cap="LDA의 직관적 예시", out.width="100%"}
...
many_models <- tibble(K = c(5, 10, 20, 30, 40, 50)) %>% 
...
```{r  topic30, message=FALSE, warning=FALSE, eval = FALSE}
